	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         responseButton = (type == 'listResponseMessage') ? caa.message.listResponseMessage.title : ''
            ...
            let faa = nuy.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "List Pinky","footerText": "❣ Base : FxSx FdlX\n❣ Recode : Pinky\n❣ Note : Mohon Jangan Spam Bot Pinky!!","listType": "SINGLE_SELECT","sections": list}}, {})
        ...
        await nuy.sendMessage(from, `${nuyfaa}`, text, options, {quoted: ftroli, contextInfo: {forwardingScore: 99999, isForwarded: true}})
          ...
          case 'help2':
               ...
               buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: 'LIST PINKY'},type:1},{buttonId:`${prefix}donasi`,buttonText:{displayText:'DONASI'},type:1},{buttonId:`${prefix}info`,buttonText:{displayText:'INFO PINKY'},type:1}]
               buttonsMessage = {
               contentText: `${menu}`,
