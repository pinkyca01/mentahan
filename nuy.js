...
async function starts() {
	...
	nuy.on('chat-update', async (caa) => {
        ...
        reply(e)
			...
			if (!isGroup && isCmd) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32mEXEC\x1b[1;37m]', time, color(command), 'from', color(pushname), 'args :', color(args.length))
			if (isGroup && !isCmd) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32mGROUP\x1b[1;37m]', time, color(command), 'from', color(pushname), 'in', color(groupName), 'args :', color(args.length))			 
			if (!isGroup && !isCmd) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32mPRIVATE\x1b[1;37m]', time, color(command), 'from', color(pushname), 'args :', color(args.length))
			if (isGroup && isCmd) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32mEXEC\x1b[1;37m]', time, color(command), 'from', color(pushname), 'in', color(groupName), 'args :', color(args.length))			 
            switch(command) {
            case 'menu':
            case 'help':
...
┬𖧹
╰────────𖧹`
           nuy.sendMessageage(from, menumaker, text, {quoted: ftroli})
           break
           case 'rules':
